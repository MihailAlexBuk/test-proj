            ...
            <div class="bricks-wrapper">
                            ...
                            <ul class="slides">
                                ...
                                <li>
                                    <div class="featured-post-slide">
                                        ...
                                        <div class="post-background" style="background-image:url({{asset('assets/images/thumbs/featured/featured-1.jpg')}});"></div>
                                        ...
                                        <div class="post-content">
                                            ...
                                            <h1 class="slide-title"><a href="post.blade.php" title="">Minimalism Never Goes Out of Style</a></h1>
                                        </div>
                                ...
                                <li>
                                    <div class="featured-post-slide">
                                        ...
                                        <div class="post-background" style="background-image:url({{asset('assets/images/thumbs/featured/featured-2.jpg')}});"></div>
                                        ...
                                        <div class="post-content">
                                            ...
                                            <h1 class="slide-title"><a href="post.blade.php" title="">Enhancing Your Designs with Negative Space</a></h1>
                                        </div>
                                ...
                                <li>
                                    <div class="featured-post-slide">
                                        ...
                                        <div class="post-background" style="background-image:url({{asset('assets/images/thumbs/featured/featured-3.jpg')}});;"></div>
                                        ...
                                        <div class="post-content">
                                            ...
                                            <h1 class="slide-title"><a href="post.blade.php" title="">Music Album Cover Designs for Inspiration</a></h1>
                                        </div>
                ...
                <article class="brick entry format-standard animate-this">
                    ...
                    <div class="entry-thumb">
                        <a href="post.blade.php" class="thumb-link">
                    ...
                    <div class="entry-text">
                        <div class="entry-header">
               			...
               			<span class="cat-links">
                            ...
                            <h1 class="entry-title"><a href="post.blade.php">Just a Standard Format Post.</a></h1>
                    ...
                    <div class="entry-text">
                        <div class="entry-header">
               			...
               			<span class="cat-links">
                            ...
                            <h1 class="entry-title"><a href="post.blade.php">This Is Another Standard Format Post.</a></h1>
                    ...
                    <div class="entry-text">
                        <div class="entry-header">
               			...
               			<span class="cat-links">
                            ...
                            <h1 class="entry-title"><a href="post.blade.php">Photography Skills Can Improve Your Graphic Design.</a></h1>
                    ...
                    <div class="entry-text">
                        <div class="entry-header">
               			...
               			<span class="cat-links">
                            ...
                            <h1 class="entry-title"><a href="post.blade.php">The 10 Golden Rules of Clean Simple Design.</a></h1>
                    ...
                    <div class="entry-text">
                        <div class="entry-header">
               			...
               			<span class="cat-links">
                            ...
                            <h1 class="entry-title"><a href="post.blade.php">You Can See Patterns Everywhere.</a></h1>
                    ...
                    <div class="entry-text">
                        <div class="entry-header">
               			...
               			<span class="cat-links">
                            ...
                            <h1 class="entry-title"><a href="post.blade.php">Breathtaking Photos of Lighthouses.</a></h1>
                    ...
                    <div class="entry-text">
                        <div class="entry-header">
               			...
               			<span class="cat-links">
                            ...
                            <h1 class="entry-title"><a href="post.blade.php">Designing With Black and White.</a></h1>
